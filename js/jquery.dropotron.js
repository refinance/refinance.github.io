...
function totalCurrentPayments() {
	...
	intpaid = parseFloat(document.getElementById('intpaid').value);
	...
	document.getElementById("balancecurrent").innerHTML = commify(balancecur.toFixed());
	}

function totalNewPayments() {
	balancenew = parseFloat(document.getElementById('balancenew').value);
...
function totalSavings() {
	...
	totalsavings = totalpaymentscur - totalpaymentsnew;
	monthlysavings = monthlypaymentcur - monthlypaymentnew;
	document.getElementById('savings').innerHTML = "You will save $" + commafy(totalsavings.toFixed()) + " in interest if you refinance.";
	}

function tableDisplay() {
	document.getElementById('principalcur').innerHTML = "$" + commafy(balancecur.toFixed(2));
	document.getElementById('interestcur').innerHTML = "$" + commafy(totalintpaymentscur.toFixed(2));
	document.getElementById('totalcur').innerHTML = "$" + commafy(totalpaymentscur.toFixed(2));
